...
class FFmpegService(
    ...
    suspend fun readChapters(filePath: String): List<Chapter> = withContext(Dispatchers.IO) {
        try {
            ...
            val result = processExecutor.execute(command, ProcessExecutor.ExecutionConfig())
    ...
    suspend fun createM4B(
        ...
        try {
            ...
            processExecutor.execute(
                command = command,
                config = ProcessExecutor.ExecutionConfig(),
    ...
    suspend fun replaceChaptersInFile(
        ...
        try {
            ...
            val removeResult = processExecutor.execute(removeCommand, ProcessExecutor.ExecutionConfig())
