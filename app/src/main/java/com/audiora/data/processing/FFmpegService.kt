...
class FFmpegService(
    ...
    suspend fun readChapters(filePath: String): List<Chapter> = withContext(Dispatchers.IO) {
        try {
            ...
            val result = processExecutor.execute(command, ProcessExecutor.ExecutionConfig(useLinker = true))
    ...
    suspend fun createM4B(
        ...
        try {
            ...
            processExecutor.execute(
                command = command,
                config = ProcessExecutor.ExecutionConfig(useLinker = true),
    ...
    suspend fun replaceChaptersInFile(
        ...
        try {
            ...
            val removeResult = processExecutor.execute(removeCommand, ProcessExecutor.ExecutionConfig(useLinker = true))
